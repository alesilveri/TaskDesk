...
import { buildSmartSlots, formatMinutes, MAX_ACTIVITY_MINUTES, MIN_ACTIVITY_MINUTES } from '../utils/time';
    ...
    <section className="mt-8 space-y-6">
      ...
      <div className="grid gap-4 lg:grid-cols-4">
        <div className="rounded-xl border border-ink/10 bg-surface p-4 lg:col-span-2">
          ...
          <div className="mt-4 grid gap-3 text-xs text-ink/70 md:grid-cols-2">
      ...
      {(availableTags.length > 0 || availableResources.length > 0) && (
        <div className="rounded-xl border border-ink/10 bg-surface p-4">
          <div className="text-xs uppercase text-ink/50">Filtri rapidi</div>
